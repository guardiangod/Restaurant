...
<c:url var="editURL" value="/owner/restaurant/update" />
<form:form modelAttribute="restaurantEditTo" action="${editURL}" method="post" id="viewRstForm" name="viewRstForm" >
	<table border="0" summary="restaurant" width="100%" cellspacing="10px">
		<tr>
			<td><label for="restaurantName">Restaurant Name*</label></td>
			<td><form:input path="restaurant.restaurantName" id="restaurantName" size="20" maxlength="30"/>
	...
	<br />
	<button id="backRstBtn"><span class="ui-icon ui-icon-arrowreturnthick-1-w"></span>Back</button>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button id="updateRstBtn">Save</button>
	<br /><br/>
	<p id="rstEditError" class="ui-state-error ui-corner-all">
		<span class="ui-icon ui-icon-alert"></span>
		<span>Click on Save to update your restaurant</span>
	</p>	
</form:form>
